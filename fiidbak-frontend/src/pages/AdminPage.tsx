    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage the platform and moderate community content
        </p>
      </div>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{mockStats.totalFeedback}</p>
            </div>
      ...
      {activeTab === 'moderation' && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Pending Feedback Moderation</h3>
            <span className="text-sm text-gray-500">{mockPendingFeedbacks.length} items</span>
          </div>
