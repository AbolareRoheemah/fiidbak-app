    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Connect your wallet to view your profile and manage your feedback.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="card text-center">
          ...
          <div className="text-2xl font-bold text-gray-900 mb-1">{mockUserStats.reputation}</div>
        ...
        <div className="card text-center">
          ...
          <div className="text-2xl font-bold text-gray-900 mb-1">{mockUserStats.approvedFeedback}</div>
        ...
        <div className="card text-center">
          ...
          <div className="text-2xl font-bold text-gray-900 mb-1">{mockUserStats.totalProducts}</div>
        ...
        <div className="card text-center">
          ...
          <div className="text-2xl font-bold text-gray-900 mb-1">{mockUserStats.totalVotes}</div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm font-medium text-gray-700 mb-2">
                ...
                <span>{nextTier.current}/{nextTier.current + nextTier.needed}</span>
              </div>
      ...
      {activeTab === 'feedback' && (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6">My Feedback</h3>
          {mockUserFeedbacks.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Start reviewing products to build your reputation.</p>
